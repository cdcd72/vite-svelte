...
- Skill：[SvelteKit](https://kit.svelte.dev/) (Svelte 5)、[TypeScript](https://www.typescriptlang.org/)、[Tailwind CSS](https://tailwindcss.com/)
...
- **Tailwind CSS v4**: Blazing fast zero-runtime engine with automatic `@import "tailwindcss"` injection via `@tailwindcss/vite`.
